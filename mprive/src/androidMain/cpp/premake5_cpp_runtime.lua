...
-- 
-- This is for the mprive (Kotlin Multiplatform) module, which uses the same
-- Rive runtime as the kotlin module but with different JNI bindings.
...
-- Build the Rive PLS Renderer (for Android GPU rendering)
